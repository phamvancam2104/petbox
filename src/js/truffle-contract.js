...
var contract = (function(module) {
  ...
  // Accepts a contracts object created with web3.eth.contracts.
  // Optionally, if called without `new`, accepts a network_id and will
  // create a new version of the contracts abstraction with that network_id set.
  ...
  Contract._static_methods = {
    ...
    new: function() {
      ...
      if (!this.unlinked_binary) {
        throw new Error(this._json.contract_name + " error: contracts binary not set. Can't deploy new instance.");
      }
    ...
    link: function(name, address) {
      ...
      if (typeof name == "function") {
        ...
        if (contract.isDeployed() == false) {
          throw new Error("Cannot link contracts without an address.");
        }

        this.link(contract.contract_name, contract.address);

        // Merge events so this contracts knows about library's events
...
var Schema = require("truffle-contracts-schema");
var Contract = require("./contracts.js");
...
var TruffleSchema = {
  ...
  normalizeOptions: function(options, extra_options) {
    ...
    // Merge options/contracts object first, then extra_options
...
module.exports={
  "_args": [
    [
      {
        "raw": "truffle-contracts-schema@0.0.5",
        "scope": null,
      ...
      "/Users/tim/Documents/workspace/Consensys/truffle-contracts"
    ]
  ],
  "_from": "truffle-contracts-schema@0.0.5",
  "_id": "truffle-contracts-schema@0.0.5",
  "_inCache": true,
  "_location": "/truffle-contracts-schema",
  "_nodeVersion": "6.9.1",
  "_npmOperationalInternal": {
    "host": "packages-12-west.internal.npmjs.com",
    "tmp": "tmp/truffle-contracts-schema-0.0.5.tgz_1485557985137_0.46875762194395065"
  },
  "_npmUser": {
    "name": "tcoulter",
  ...
  "_resolved": "https://registry.npmjs.org/truffle-contracts-schema/-/truffle-contracts-schema-0.0.5.tgz",
  "_shasum": "5e9d20bd0bf2a27fe94310748249d484eee49961",
  "_shrinkwrap": null,
  "_spec": "truffle-contracts-schema@0.0.5",
  "_where": "/Users/tim/Documents/workspace/Consensys/truffle-contracts",
  "author": {
    "name": "Tim Coulter",
  ...
  "description": "JSON schema for contracts artifacts",
  "devDependencies": {
    "mocha": "^3.2.0"
  },
  "directories": {},
  "dist": {
    ...
    "tarball": "https://registry.npmjs.org/truffle-contracts-schema/-/truffle-contracts-schema-0.0.5.tgz"
  },
